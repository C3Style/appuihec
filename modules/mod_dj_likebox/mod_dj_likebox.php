...
$params->set('width',$params->get('width',292));
$params->set('colorscheme',$params->get('colorscheme','light'));
$params->set('show_faces',$params->get('show_faces',1) ? 'true' : 'false');
$params->set('stream',$params->get('stream',1) ? 'true' : 'false');
$params->set('header',$params->get('header',1) ? 'true' : 'false');
...
if(!$params->get('height',0)){
	...
	if($params->get('header')=='false' || $params->get('add_css')) $height -= 32;
	$params->set('height',$height);
}

require(JModuleHelper::getLayoutPath('mod_dj_likebox'));
