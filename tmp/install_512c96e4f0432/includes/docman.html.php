 ...
 * @version $Id: docman.html.php 1381 2010-06-14 11:40:22Z mathias $
 * @package DOCman_1.4
...
class HTML_DMDocman
{
    ...
    function showCPanel()
    {
        ...
        <table class="adminform">
        	<tr>
        		<td colspan="20" style="border: 1px solid red; background-color:#DEDEDE;padding:5px; margin:5px;text-align:center">
        			This version of DOCman is outdated. Get the latest from upgrade from <a href="<?php echo _DM_JOOMLATOOLS_URL?>"><?php echo _DM_JOOMLATOOLS_URL?></a>
        		</td>
        	</tr>
            <tr>
