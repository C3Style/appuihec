...
//		$userLevels = $user->getAuthorisedViewLevels();
		...
		// CLN : automatic approve event when created
...
//		$data->id 					= JRequest::getVar('id', '', 'post');
		...
		*/
		$arr = array("statutReg" => "1", "accessReg" => "5", "RegButtonLink" => "", "RegButtonLink_Article" => "", "RegButtonLink_Url" => "",
			  "typeReg" => "1", "maxReg" => "", "maxRlistGlobal" => "", "maxRlist" => "", "RegButtonText" => "", "RegButtonTarget" => "0", "atevent" => "");
